...
Dans ce mode, Mysoleas Identity Cloud remplace la brique identite de votre application. Il ne vous oblige pas a utiliser SoleasPay, MyShup, MyBoost ou la gateway.
