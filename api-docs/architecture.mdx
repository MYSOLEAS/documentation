...
| Metier | MyShup | Produits, commandes et automatisation commerciale |
| Metier | Notification Service | Communications transactionnelles, contacts, audiences et campagnes marketing V2 |
| Metier | MyBoost | Campagnes boost, challenges UGC, promotions et marketing |
...
| Checkout v4 | `pay.soleaspay.com` | `apiKey` marchand |
| Button v4 | `btn.soleaspay.com` | `data-apikey` marchand |
...
MyShup porte la gestion et l'automatisation des ventes. Il intervient dans les parcours commerciaux, les produits, les commandes mono-produit ou multi-produits, et les operations marchandes.

### Notification Service

Le Notification Service centralise les communications transactionnelles: confirmations, alertes, messages systeme et notifications liees aux evenements. Il porte aussi l'API marketing V2 pour les contacts, audiences, templates et campagnes, avec Listmonk comme moteur interne.

### MyBoost

MyBoost couvre le marketing a travers des campagnes boost, des challenges UGC, des promotions, l'activation client et la relance marketing.
...
Les plugins SoleasPay v4 ne suivent pas le meme modele que les appels gateway serveur a serveur.

| Plugin | URL | Authentification | Role |
| --- | --- | --- | --- |
| Checkout v4 | `https://pay.soleaspay.com` | `apiKey` | Page de paiement hebergee |
| Button v4 | `https://btn.soleaspay.com/main.js` | `data-apikey` | Bouton JavaScript integre dans votre page |
