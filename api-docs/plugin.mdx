---
title: "Plugins SoleasPay v4"
description: "Integrez SoleasPay rapidement avec Checkout v4 ou Button v4, uniquement avec votre API key."
---

Les plugins SoleasPay v4 sont concus pour integrer le paiement dans une application tierce sans gerer OAuth, JWT, intent, execute ou status cote marchand.
...
| --- | --- | --- |
| Checkout v4 | Formulaire ou payload envoye vers `https://pay.soleaspay.com` | Page de paiement complete hebergee par SoleasPay |
| Button v4 | Script JavaScript `https://btn.soleaspay.com/main.js` | Bouton de paiement integre directement dans votre page |
