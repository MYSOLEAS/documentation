...
Button v4 s'integre avec un script JavaScript et une API key marchand. Aucun token OAuth n'est requis.

Utilisez Button v4 si vous voulez afficher le paiement directement dans une page produit, panier, facture ou espace client.
...
| `src` | Oui | URL du plugin Button v4 |
